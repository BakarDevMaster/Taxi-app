...
const testimonials: Testimonial[] = [
  {
    title: "I just have to focus on my business",
    content: "“As a small startup, competing with giants like Uber seemed daunting until I found Onde app, offering easy payment systems and essential features like custom branding and fixed rate zones. Plus, they handle all updates and maintenance, letting me focus on my business”",
    author: "Sarah M.",
    position: "CEO",
    rating: 5
  },
    ...
    <div className="max-w-6xl mx-auto px-4 py-16 lg:py-24">
      <div className="grid lg:grid-cols-[400px,1fr] gap-8">
        ...
        <div className="lg:sticky lg:top-28 lg:h-fit">
          ...
          Used by <span className='text-[#00D262]'>400+ businesses all</span> over the world
          </h2>
